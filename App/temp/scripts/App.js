...
var _MonitorText = __webpack_require__(5);
...
var _SeparatorAnimation = __webpack_require__(7);

var _SeparatorAnimation2 = _interopRequireDefault(_SeparatorAnimation);
...
var _EduExp = __webpack_require__(10);

var _EduExp2 = _interopRequireDefault(_EduExp);
...
var eduExp = new _EduExp2.default();
...
var Menu = function () {
  function Menu() {
    ...
    this.navLinks = (0, _jquery2.default)('.nav__link');
    this.trigger = (0, _jquery2.default)('.header-title__text');
    this.sections = (0, _jquery2.default)('section');
    this.navIcon = (0, _jquery2.default)('.nav-icon');
    this.navCloser = (0, _jquery2.default)('.nav-icon__closer');
  ...
  _createClass(Menu, [{
    ...
    key: 'createMatchingLinks',
    value: function createMatchingLinks() {
      var _this = this;

      this.sections.each(function (i) {
        var currentSection = _this.sections[i];
        var that = _this;
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction === 'down') {
              ...
              (0, _jquery2.default)(matchingLink).addClass('nav__link--current');
            }
          },
          offset: '18%'
        });
    ...
    value: function createWaypoint() {
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          if (direction === "down") {
            _this2.navLinks.addClass('nav__link--more-visible');
            _this2.nav.addClass('nav--more-visible');
            if (_this2.navIcon) {
            ...
            _this2.nav.removeClass('nav--more-visible');
            if (_this2.navIcon) {
...
var SeparatorAnimation = function () {
  function SeparatorAnimation() {
    _classCallCheck(this, SeparatorAnimation);

    this.sections = (0, _jquery2.default)('.title--section');
    this.titles = (0, _jquery2.default)('.my-stack-separator');
    this.createWaypoint();
  }

  _createClass(SeparatorAnimation, [{
    key: 'createWaypoint',
    value: function createWaypoint() {
      var that = this;
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            if (direction === 'down') {
              ...
              (0, _jquery2.default)(currentTitle).removeClass('my-stack-separator--visible');
            }
          },
          offset: '90%'
        });
  ...
  return SeparatorAnimation;
}();

exports.default = SeparatorAnimation;
...
var EduExp = function () {
  function EduExp() {
    _classCallCheck(this, EduExp);

    this.expButton = (0, _jquery2.default)('.icon-exp');
    this.eduButton = (0, _jquery2.default)('.icon-edu');
    this.eduExpContainers = (0, _jquery2.default)('.eduexp-container');
    this.iconLink = (0, _jquery2.default)('.icon-link');
